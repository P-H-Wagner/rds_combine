...
export var=$1
export datetime_mu7=$2
export datetime_mu9=$3
export data=$4
...
if [[ $var == "combo" ]]; then
  path_mu7="/work/pahwagne/RDsTools/fit/datacards_binned/$datetime_mu7/${folder}*_ch*"
  path_mu9="/work/pahwagne/RDsTools/fit/datacards_binned/$datetime_mu9/${folder}*_ch*"

else
  path_mu7="/work/pahwagne/RDsTools/fit/datacards_binned/$datetime_mu7/${folder}*${var}*_ch*"
  path_mu9="/work/pahwagne/RDsTools/fit/datacards_binned/$datetime_mu9/${folder}*${var}*_ch*"
fi
                                                                   
dest_mu7="/work/pahwagne/RDsTools/fit/datacards_binned/$datetime_mu7/${folder}datacard_${var}_in_regions_combined.txt"
dest_mu9="/work/pahwagne/RDsTools/fit/datacards_binned/$datetime_mu9/${folder}datacard_${var}_in_regions_combined.txt"
...
dest="/work/pahwagne/RDsTools/fit/datacards_binned/$datetime/${folder}datacard_${var}_in_regions_and_trigger_combined.txt"
...
if $asimov; then
  ...
  #########################################################
  # run 1D fit for rDs with rDsStar float + freeze all #
  #########################################################
  
  combine -M MultiDimFit my_workspace_binned.root --algo grid --points 200 --saveInactivePOI 1 -P rDs     --floatOtherPOIs 1 -t -1 -v 1 -n _1D_scan_rDs_2nd_float_binned_stat_only --setParameters rDs=1,rDsStar=1 --freezeParameters $all
  plot1DScan.py higgsCombine_1D_scan_rDs_2nd_float_binned_stat_only.MultiDimFit.mH120.root --POI rDs -o 1D_scan_rDs_2nd_float_binned_stat_only --main-label "Stat. only"  --main-color=4 #--others "higgsCombine_1D_scan_rDs_2nd_float_binned.MultiDimFit.mH120.root:Asimov:2" 

  #########################################################
  # run 1D fit for rDs with rDsStar float + freeze hammer #
  #########################################################
  
  combine -M MultiDimFit my_workspace_binned.root --algo grid --points 200 --saveInactivePOI 1 -P rDs     --floatOtherPOIs 1 -t -1 -v 1 -n _1D_scan_rDs_2nd_float_binned_hammer_freeze --setParameters rDs=1,rDsStar=1 --freezeParameters $hammer


  plot1DScan.py higgsCombine_1D_scan_rDs_2nd_float_binned_stat_only.MultiDimFit.mH120.root --POI rDs -o 1D_scan_rDs_2nd_float_binned_stat_only --main-label "Stat. only"  --main-color 1 \
  --others "higgsCombine_1D_scan_rDs_2nd_float_binned_hammer_freeze.MultiDimFit.mH120.root:Freeze Hammer:4" "higgsCombine_1D_scan_rDs_2nd_float_binned.MultiDimFit.mH120.root:Asimov:2" 
  ...
  ######################################################################
  ## run 1D fit for rDs with rDsStar float + freeze hammer Systematics #
  ######################################################################
  #
  #combine -M MultiDimFit my_workspace_binned.root --algo grid --points 200 --saveInactivePOI 1 -P rDs     --floatOtherPOIs 1 -t -1 -v 1 --setParameters rDs=1     --freezeParameters e1Bgl,e2Bgl,e3Bgl,e4Bgl,e5Bgl,e6Bgl,e7Bgl,e8Bgl,e9Bgl,e10Bgl,e1Bcl,e2Bcl,e3Bcl,e4Bcl,e5Bcl,e6Bcl -n _1D_scan_rDs_2nd_float_freeze_hammer_sys_binned
  #plot1DScan.py higgsCombine_1D_scan_rDs_2nd_float_binned.MultiDimFit.mH120.root --others "higgsCombine_1D_scan_rDs_2nd_float_freeze_hammer_sys_binned.MultiDimFit.mH120.root:Stat-Only:2" --main-label "Asimov" --POI rDs -o 1D_scan_rDs_2nd_float_hammer_sys_binned  

  ######################################################################
  ## run 1D fit for rDs with rDsStar float + freeze rate systematics #
  ######################################################################
  #
  #combine -M MultiDimFit my_workspace_binned.root --algo grid --points 200 --saveInactivePOI 1 -P rDs     --floatOtherPOIs 1 -t -1 -v 1 --setParameters rDs=1     --freezeParameters  bs,r_comb,r_hb -n _1D_scan_rDs_2nd_float_freeze_rate_sys_binned
  #plot1DScan.py higgsCombine_1D_scan_rDs_2nd_float_binned.MultiDimFit.mH120.root --others "higgsCombine_1D_scan_rDs_2nd_float_freeze_rate_sys_binned.MultiDimFit.mH120.root:Stat-Only:2" --main-label "Asimov" --POI rDs -o 1D_scan_rDs_2nd_float_rate_sys_binned  

  ##################################################################################
  ## run 1D fit for rDs with rDsStar float + freeze rate and other poi systematics #
  ##################################################################################
  #
  #combine -M MultiDimFit my_workspace_binned.root --algo grid --points 200 --saveInactivePOI 1 -P rDs     --floatOtherPOIs 0 -t -1 -v 1 --setParameters rDs=1     --freezeParameters  bs,r_comb,r_hb -n _1D_scan_rDs_2nd_float_freeze_rate_and_other_poi_sys_binned
  #plot1DScan.py higgsCombine_1D_scan_rDs_2nd_float_binned.MultiDimFit.mH120.root --others "higgsCombine_1D_scan_rDs_2nd_float_freeze_rate_and_other_poi_sys_binned.MultiDimFit.mH120.root:Stat-Only:2" --main-label "Asimov" --POI rDs -o 1D_scan_rDs_2nd_float_rate_and_other_poi_sys_binned  
  ...
  ######################################################
  # run 1D fit for rDsStar with rDs float + freeze all #
  ######################################################
  
  combine -M MultiDimFit my_workspace_binned.root --algo grid --points 200 --saveInactivePOI 1 -P rDsStar --floatOtherPOIs 1 -t -1 -v 1  -n _1D_scan_rDsStar_2nd_float_binned_stat_only --setParameters rDs=1,rDsStar=1 --freezeParameters $all
  plot1DScan.py higgsCombine_1D_scan_rDsStar_2nd_float_binned_stat_only.MultiDimFit.mH120.root --POI rDsStar -o 1D_scan_rDsStar_2nd_float_binned_stat_only --main-label "Stat. only"  --main-color=4 #--others "higgsCombine_1D_scan_rDsStar_2nd_float_binned.MultiDimFit.mH120.root:Asimov:2" 
 
  #########################################################
  # run 1D fit for rDsStar with rDs float + freeze hammer #
  #########################################################
  
  combine -M MultiDimFit my_workspace_binned.root --algo grid --points 200 --saveInactivePOI 1 -P rDsStar --floatOtherPOIs 1 -t -1 -v 1  -n _1D_scan_rDsStar_2nd_float_binned_hammer_freeze --setParameters rDs=1,rDsStar=1 --freezeParameters $hammer

  plot1DScan.py higgsCombine_1D_scan_rDsStar_2nd_float_binned_stat_only.MultiDimFit.mH120.root --POI rDsStar -o 1D_scan_rDsStar_2nd_float_binned_stat_only --main-label "Stat. only"  --main-color=1 \
  --others "higgsCombine_1D_scan_rDsStar_2nd_float_binned_hammer_freeze.MultiDimFit.mH120.root:Freeze Hammer:4" "higgsCombine_1D_scan_rDsStar_2nd_float_binned.MultiDimFit.mH120.root:Asimov:2" 
 
  ##############################################################
  # run 1D fit for rDsStar with rDs float + freeze Systematics #
  ##############################################################
  
  #combine -M MultiDimFit my_workspace_binned.root --algo grid --points 100 --saveInactivePOI 1 -P rDsStar --floatOtherPOIs 1 -t -1 -v 0 --setParameters rDs=1,rDsStar=1 --freezeParameters rgx{*} -n _1D_scan_rDsStar_2nd_float_freeze_sys_binned
  ...
  #plot1DScan.py higgsCombine_1D_scan_rDsStar_2nd_float_binned.MultiDimFit.mH120.root --others "higgsCombine_1D_scan_rDsStar_2nd_float_freeze_sys_binned.MultiDimFit.mH120.root" --main-label "Asimov" --POI rDsStar -o 1D_scan_rDsStar_2nd_float_sys_binned  
 
  #####################################################################
  # run 1D fit for rDsStar with rDs float + hammer freeze Systematics #
  #####################################################################
  
  #combine -M MultiDimFit my_workspace_binned.root --algo grid --points 200 --saveInactivePOI 1 -P rDsStar --floatOtherPOIs 1 -t -1 -v 0 --setParameters rDs=1,rDsStar=1 --freezeParameters e1Bgl,e2Bgl,e3Bgl,e4Bgl,e5Bgl,e6Bgl,e7Bgl,e8Bgl,e9Bgl,e10Bgl,e1Bcl,e2Bcl,e3Bcl,e4Bcl,e5Bcl,e6Bcl -n _1D_scan_rDsStar_2nd_float_freeze_hammer_sys_binned
  #plot1DScan.py higgsCombine_1D_scan_rDsStar_2nd_float_binned.MultiDimFit.mH120.root --others "higgsCombine_1D_scan_rDsStar_2nd_float_freeze_hammer_sys_binned.MultiDimFit.mH120.root:Stat-Only:2" --main-label "Asimov" --POI rDsStar -o 1D_scan_rDsStar_2nd_float_hammer_sys_binned  
  #plot1DScan.py higgsCombine_1D_scan_rDsStar_2nd_float_freeze_hammer_sys_binned.MultiDimFit.mH120.root  --POI rDsStar -o 1D_scan_rDsStar_2nd_float_hammer_sys_binned  

  ###################################################################
  # run 1D fit for rDsStar with rDs float + freeze rate Systematics #
  ###################################################################
  
  #combine -M MultiDimFit my_workspace_binned.root --algo grid --points 100 --saveInactivePOI 1 -P rDsStar --floatOtherPOIs 1 -t -1 -v 0 --setParameters rDs=1,rDsStar=1 --freezeParameters bs,r_comb,r_hb -n _1D_scan_rDsStar_2nd_float_freeze_rate_sys_binned
  #plot1DScan.py higgsCombine_1D_scan_rDsStar_2nd_float_binned.MultiDimFit.mH120.root --others "higgsCombine_1D_scan_rDsStar_2nd_float_freeze_rate_sys_binned.MultiDimFit.mH120.root:Stat-Only:2" --main-label "Asimov" --POI rDsStar -o 1D_scan_rDsStar_2nd_float_rate_sys_binned  
  #plot1DScan.py higgsCombine_1D_scan_rDsStar_2nd_float_freeze_rate_sys_binned.MultiDimFit.mH120.root --POI rDsStar -o 1D_scan_rDsStar_2nd_float_rate_sys_binned  

  ###################################################################
  # run 1D fit for rDsStar with rDs float + freeze rate Systematics #
  ###################################################################
  
  #combine -M MultiDimFit my_workspace_binned.root --algo grid --points 100 --saveInactivePOI 1 -P rDsStar --floatOtherPOIs 0 -t -1 -v 0 --setParameters rDs=1,rDsStar=1 --freezeParameters bs,r_comb,r_hb -n _1D_scan_rDsStar_2nd_float_freeze_rate_and_other_poi_sys_binned
  #plot1DScan.py higgsCombine_1D_scan_rDsStar_2nd_float_binned.MultiDimFit.mH120.root --others "higgsCombine_1D_scan_rDsStar_2nd_float_freeze_rate_and_other_poi_sys_binned.MultiDimFit.mH120.root:Stat-Only:2" --main-label "Asimov" --POI rDsStar -o 1D_scan_rDsStar_2nd_float_rate_and_other_poi_sys_binned  
  #plot1DScan.py higgsCombine_1D_scan_rDsStar_2nd_float_freeze_rate_and_other_poi_sys_binned.MultiDimFit.mH120.root  --POI rDsStar -o 1D_scan_rDsStar_2nd_float_rate_and_other_poi_sys_binned  
